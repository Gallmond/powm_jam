...
function TIC()
	...
	print("music_started: " .. tostring(music_started), 5,5,1)
	t=t+1
	
	if music_started == 0 then
		if time() > 1000 then
...
-- <SFX>
-- 000:010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100307000000000
-- </SFX>
